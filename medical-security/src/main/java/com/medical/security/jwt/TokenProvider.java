...
public class TokenProvider {
    ...
    public String createToken(final Authentication authentication) {
        final LocalUser userPrincipal = (LocalUser) authentication.getPrincipal();
    ...
    public Long getUserIdFromToken(final String token) {
        final Claims claims = Jwts.parser().setSigningKey(this.appProperties.getAuth().getTokenSecret()).parseClaimsJws(token).getBody();
